...
class Bokningsfunk {
	...
	public function create_bookingform() {
		...
		$output[] = '<div style="float:right;"><a href="javascript: void(0)" onclick="cancelEdit()"><img src="'.$this->conf['wpath'].'close.png" alt="X" title="Stäng" /></a></div>';
		$output[] = '<p style="display:block; position:absolute; width: 158px;">';
		$output[] = '	<span class="small">Datum:</span>';
		$output[] = '	<input type="text" name="datum" value="" size="11" style="width:150px;" onchange="setEditShow(\'datum\',this.value,\'\')" class="hide" id="datum_edit"'.($this->auth->loggedin()?'':' readonly="readonly"').' />';
		$output[] = '	<span id="datum_show" class="show" onclick="showEdit();"></span>';
		$output[] = '</p>';
		$output[] = '<p style="display:block; position:absolute; margin-left:165px;">';
		$output[] = '	<span class="small">Bokad:</span><br />';
		$output[] = '	<input type="text" name="bokad" value="'.date('Y-m-d').'" size="11" style="width:150px;" onchange="setEditShow(\'bokad\',this.value,\'\')" class="hide" id="bokad_edit" />';
		...
		if($this->auth->loggedin()) {
			...
			$output[] = '		<input type="radio" name="bokn" value="3" onchange="setEditShow(\'bokn\',this.value,\'\')" /><span onclick="setEditShow(\'bokn\',3,\'\')"> Avbokad</span>';
			$output[] = '	</div>';
			$output[] = '	</div>';
		...
		$output[] = '	<input type="text" name="namn" value="" size="25" style="width:315px;" id="namn_edit" class="hide" onchange="setEditShow(\'namn\',this.value,\'\')" />';
		$output[] = '	<span id="namn_show" class="show" onclick="showEdit();"></span>';
		$output[] = '</p>';
		$output[] = '<p>';
		$output[] = '	<span class="small">Epost:</span><br />';
		$output[] = '	<input type="text" name="epost" value="" size="25" style="width:315px;" id="epost_edit" class="hide" onchange="setEditShow(\'epost\',this.value,\'mailto:\'+this.value)" />';
		$output[] = '	<a href="" id="epost_show" class="show"></a>';
		$output[] = '</p>';
		$output[] = '<p>';
		$output[] = '	<span class="small">Telefon:</span><br />';
		$output[] = '	<input type="text" name="phone" value="" size="25" style="width:315px;" id="phone_edit" class="hide" onchange="setEditShow(\'phone\',this.value,\'tel:\'+this.value)" />';
		$output[] = '	<a href="" id="phone_show" class="show"></a>';
		$output[] = '</p>';
		$output[] = '<p>';
		$output[] = '	<span class="small">Alternativ telefon:</span><br />';
		$output[] = '	<input type="text" name="phone_alt" value="" size="25" style="width:315px;"  id="phone_alt_edit" class="hide" onchange="setEditShow(\'phone_alt\',this.value,\'tel:\'+this.value)" />';
		...
		$output[] = '	<textarea rows="3" cols="25" name="info" style="width:315px;" id="info_edit" class="hide" onchange="setEditShow(\'info\',this.value,\'\')"></textarea>';
		...
		$output[] = '</p>';
		$output[] = '<p>';
		$output[] = '	<input type="button" value=" Avbryt " onclick="cancelEdit()" style="float:left;" />';
